...
# testing
# encrypter = Encrypter("05055308496872320218721")
# print(encrypter.decrypt(encrypter.encrypt("Exterminate!")).decode())
"""
try:
    encrypter_object = hospital_files.Encrypter("59fe02f84005d78bbe2bae893debaafc")  # must be 16 bytes at least.
    msg = encrypter_object.encrypt("Hello")
    print(msg)
    print(encrypter_object.decrypt(msg, string=True))
